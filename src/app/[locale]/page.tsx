    ...
    <PageShell>
      ...
      <main>
        <HomeFunnelHero
          ...
          pathSelectorLabel={t("pathSelectorLabel")}
          ...
          visualEyebrow={t("visual.eyebrow")}
          visualBuilding={t("visual.building")}
          visualKnown={t("visual.known")}
          visualUnknown={t("visual.unknown")}
          visualVerify={t("visual.verify")}
          visualSource={t("visual.source")}
          visualReply={t("visual.reply")}
        />
        ...
        <section className="remote-ownership-band" aria-labelledby="remote-heading">
          <div>
