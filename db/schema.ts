...
export const leadSubmissions = pgTable(
  "lead_submissions",
  {
    ...
    targetAreaOrBuilding: text("target_area_or_building"),
    budgetRange: text("budget_range"),
    buyerTimeline: text("buyer_timeline"),
    financingPosture: text("financing_posture"),
    buyerAvoidance: text("buyer_avoidance"),
    buildingUnit: text("building_unit"),
    currentlyListed: boolean("currently_listed"),
    sellerTimeline: text("seller_timeline"),
    sellerPain: text("seller_pain"),
